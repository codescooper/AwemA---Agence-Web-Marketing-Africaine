...
│           └── exemple-client/   ← MISSION 1 (cabinet d'optique, Yopougon)
│
...
| Sur la **mission Exemple Client** | [`departements/marketing/clients/exemple-client/README.md`](departements/marketing/clients/exemple-client/README.md) |
| À la recherche d'un **outil** (revue de visuels…) | [`outils/README.md`](outils/README.md) |

---

## 🏥 Mission en cours — Exemple Client

**Client :** Exemple Client — Cabinet d'optique
...
➡️ Tout est dans [`departements/marketing/clients/exemple-client/`](departements/marketing/clients/exemple-client/).
